...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TeamSummary = React.createClass({displayName: "TeamSummary",
	    render: function() {
	        ...
	        return (
	            ...
	            React.createElement("th", {style: team}, 
	                React.createElement("div", {style: style}, 
	                    React.createElement("abbr", {style: abbr}, this.props.abbr.toUpperCase()), React.createElement("br", null)
	                )
	            ), 
	            this.props.inning && React.createElement("td", {rowSpan: 2, style: count}, this.props.inning), 
	            React.createElement("td", {style: runs}, this.props.runs)
	            )
	        );
	    }
	});
	 ...
	 * summary of the Runs, Hits and Errors for that game */
	 var GameCardAL = React.createClass({displayName: "GameCardAL",
	     contextTypes: {
	     ...
	     render: function() {
	         ...
	         return (
	             ...
	             React.createElement("table", {style: boxScore}, 
	             React.createElement("tbody", null, 
	                 React.createElement(TeamSummary, {
	                     code: game.away_code, 
	 ...
	 var GameListAL = React.createClass({displayName: "GameListAL",
	     contextTypes: {
	         router: React.PropTypes.func
	     },
	     render: function() {
	         ...
	         var gameListAL = ( React.createElement("tr", null) );
	         if (scoreboard !== null) {
	             gameListAL = scoreboard.game.map(function(game) {
	                 return (React.createElement(GameCardAL, {game: game}))
	             });
	         }
	         return (
	             React.createElement("div", {style: flexbox}, " ", gameListAL, " ")
	         );
	     }
	 });

	var GameCardNL = React.createClass({displayName: "GameCardNL",
	    contextTypes: {
	        router: React.PropTypes.func
	    },
	    render: function() {
	...
	var GameListNL = React.createClass({displayName: "GameListNL",
	    contextTypes: {
	        router: React.PropTypes.func
	    },
	    render: function() {
	        ...
	        var scoreboard = this.props.scoreboard;
	        var gameListNL = ( React.createElement("tr", null) );
	        if (scoreboard !== null) {
	            gameListNL = scoreboard.game.map(function(game) {
	                return (React.createElement(GameCardNL, {game: game}))
	            });
	        }
	        return (
	            React.createElement("div", {style: flexbox}, " ", gameListNL, " ")
	        );
	    }
	});
	...
	var StandingsList = React.createClass({displayName: "StandingsList",
	    contextTypes: {
	        router: React.PropTypes.func
	    },
	    render: function() {
	      ...
	      if (standings !== null) {
	        var standingsList = standings.standing.map(function(d, idx){
	          if(d.conference === 'AL' && d.division ==='E'){
	            ...
	            return (React.createElement("tr", null, React.createElement("td", {style: count, key: idx}, d.first_name.toUpperCase()), 
	                React.createElement("td", {style: count}, d.won), 
	                React.createElement("td", {style: count}, d.lost), 
	                React.createElement("td", {style: count}, gamesBack), 
	                half ? React.createElement("td", {style: count}, React.createElement("sup", null, "1"), "/", React.createElement("sub", null, "2")) : React.createElement("td", {style: count})
	              ))
	          }
	      })
	        }
	        return (
	          React.createElement("div", {style: standingsBox}, 
	           React.createElement("p", {style: heading}, "AL EAST"), 
	            React.createElement("table", {style: division}, 
	            React.createElement("th", null), 
	            React.createElement("th", null, "W"), 
	            React.createElement("th", null, "L"), 
	            React.createElement("th", null, "GB"), 
	            React.createElement("tbody", null, " ", standingsList))
	          )
	        );
	    }
	});
	...
	var Scoreboard = React.createClass({displayName: "Scoreboard",
	    ...
	    render: function() {
	        ...
	        return (
	            React.createElement("div", null, 
	                React.createElement(StandingsList, {standings: standings}), 
	                React.createElement(GameListNL, {scoreboard: scoreboard}), 
	                React.createElement(GameListAL, {scoreboard: scoreboard}), 
	                React.createElement(LineScore, {home: boxscore.home_team_code.toUpperCase(), 
	...
	var App = React.createClass({displayName: "App",
	    render: function() {
	        return (
	            React.createElement("div", null, 
	                React.createElement(Scoreboard, {date: today}), 
	...
	var HeaderCell = React.createClass({displayName: "HeaderCell",
	    render: function() {
	    return (React.createElement("th", {style: headerCellStyle}, this.props.inning.inning)); }
	});

	var HomeCell = React.createClass({displayName: "HomeCell",
	    render: function() { return (React.createElement("td", {style: inningCellStyle}, this.props.inning.home)); }
	});

	var AwayCell = React.createClass({displayName: "AwayCell",
	    render: function() { return (React.createElement("td", {style: inningCellStyle}, this.props.inning.away)); }
	});
	    ...
	    render: function() {
	        ...
	        React.createElement("tr", null, 
	            ...
	            this.props.innings.map(function(inning) {
	                return (React.createElement(HeaderCell, {inning: inning}))
	            })
	        ));
	    }
	});

	var HomeRow = React.createClass({displayName: "HomeRow",
	    render: function() {
	        return (
	        React.createElement("tr", null, 
	            React.createElement("td", {style: inningCellStyle}, this.props.team), 
	            this.props.innings.map(function(inning) {
	                return (React.createElement(HomeCell, {inning: inning}))
	            })
	        ));
	    }
	});
	//this.props.innings.map
	var AwayRow = React.createClass({displayName: "AwayRow",
	    render: function() {
	        return (
	        React.createElement("tr", null, 
	            React.createElement("td", {style: inningCellStyle}, this.props.team), 
	            this.props.innings.map(function(inning) {
	                return (React.createElement(AwayCell, {inning: inning}))
	            })
	        ));
	    }
	});
	...
	var LineScore = React.createClass({displayName: "LineScore",
	    render: function() {
	        ...
	        return (
	            ...
	            React.createElement("tbody", null, 
	                React.createElement(AwayRow, {team: this.props.away, innings: linescore}), 
	                React.createElement(HomeRow, {team: this.props.home, innings: linescore})
	            )
	            )
	            )
	        )
	...
	var Game = React.createClass({displayName: "Game",
	    ...
	    render: function() {
	        ...
	        if (scoreboard !== null && scoreboard.data !== null) {
	            ...
	            return (
	                React.createElement("div", null, 
	                    React.createElement(LineScore, {home: home, away: away, linescore: linescore.inning_line_score})
	                )
	            );
	        }
	        else {
	...
	var routes = (
	    React.createElement(Route, {handler: App}, 
	        ...
	        React.createElement(Route, {name: "game", path: "game/:gid/:away/:home", handler: Game})
	    )
	);
